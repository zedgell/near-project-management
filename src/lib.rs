...
mod tests {
    ...
    fn test_get_all_projects() {
        ...
        for i in 1..5 {
            contract.add_project(i.to_string(),
    ...
    fn test_create_project() {
        ...
        // instantiate a contract
        let mut contract = ProjectManagement::new();
        contract.add_project("1".parse().unwrap(),
                                      "https://github.com/test-project/issues/1".to_string(),
                                      "This is a test".to_string(),
                                      "2000".parse().unwrap());
    }
    ...
    fn test_add_user_to_project() {
        ...
        let id = contract.add_project("1".parse().unwrap(),
                                      ...
                                      "This is a test".to_string(),
                                      "100".parse().unwrap());
        contract.set_user_for_project(id.clone(), worker_account.clone());
        ...
        let id = contract.add_project("2".parse().unwrap(),
                                      ...
                                      "2000".parse().unwrap());
        contract.set_user_for_project(id.clone(), worker_account.clone());
        contract.set_project_complete(id.clone());
    }
}
